> Re-homed package note: this former standalone skill now lives under `creative/creative-code-motion/references/ascii-art/`. Any legacy path such as `references/...`, `templates/...`, `scripts/...`, or `assets/...` should be resolved relative to this package directory, not the umbrella skill root.
